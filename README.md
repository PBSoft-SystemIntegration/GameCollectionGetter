# GameCollectionGetter – løsning

På `OtherKeywords` er GET, POST, PUT, PATCH og DELETE implementeret i hver sin Handle-metode.
Startprojektet med kun GET ligger på `master`.
...
get
get 0
post TestGame Action 2026
put 2 UpdatedGame Adventure 2025
patch 2 NewTitle
get 2
delete 2
exit
...
Brug id'et fra POST-svaret; 2 er kun et eksempel.
POST og PUT opretter et Game-objekt og serialiserer det med JsonSerializer.Serialize.
PATCH sender et objekt med kun Title. Genre og år er ikke med i JSON og bevares derfor af API'et.
POST returnerer 201 og JSON; PUT, PATCH og DELETE returnerer 204 uden svartekst.
ShowResponse viser statuskode og eventuel svartekst, også ved API-fejl.
